...
class CalculatorServiceTests {
    ...
    private CalculatorServiceTests(@Value("${rate}") BigDecimal rate,
    ...
    void givenValidScoringDataRequestedAmountReturnedCorrectly() {
    ...
    void givenValidScoringDataTermDoesNotChange() {
    ...
    void givenValidScoringDataRateIsCalculatedCorrectly() {
    ...
    void givenValidScoringDataMonthlyPaymentIsCalculatedCorrectly() {
        CreditDto credit = calculatorService.getCredit(validScoringData);
    ...
    void givenValidScoringDataPskIsCalculatedCorrectly() {
        CreditDto credit = calculatorService.getCredit(validScoringData);
    ...
    void givenValidScoringDataReturnScheduleWithTermElements(int term) {
    ...
    void givenValidScoringDataReturnScheduleWithCorrectPaymentNumbers() {
        CreditDto credit = calculatorService.getCredit(validScoringData);
    ...
    void givenValidScoringDataReturnScheduleWithTheSameMonthlyPayment() {
        CreditDto credit = calculatorService.getCredit(validScoringData);
    ...
    private BigDecimal calculateMonthlyPayment(BigDecimal requestedAmount,
        ...
        BigDecimal monthlyPay = requestedAmount.multiply(monthlyRate);
